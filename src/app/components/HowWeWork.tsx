    ...
    return (
        <section className="bg-[#F8F8F8] py-20 font-poppins">
            <div className="text-center mb-10">
                <h2 className="text-5xl font-semibold text-[#002B5B]">How We Work</h2>
            </div>
                ...
                <div className="relative w-full lg:w-1/2">
                    ...
                    <div className="space-y-10 pl-12 relative z-10">
                        ...
                        <div className="flex gap-4 items-start">
                            ...
                            <div>
                                <h3 className="text-[#002B5B] font-semibold text-lg">Client Discovery</h3>
                        ...
                        <div className="flex gap-4 items-start">
                            ...
                            <div>
                                <h3 className="text-[#002B5B] font-semibold text-lg">Saudi Market Research</h3>
                                <p className="text-gray-700 text-[15px] mt-1 leading-relaxed">
                        ...
                        <div className="flex gap-4 items-start">
                            ...
                            <div>
                                <h3 className="text-[#002B5B] font-semibold text-lg">Strategic Development</h3>
                                <p className="text-gray-700 text-[15px] mt-1 leading-relaxed">

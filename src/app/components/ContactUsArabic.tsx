        ...
        <section className="bg-[#FDFBFA] py-20 font-poppins">
            <div className="max-w-7xl mx-auto px-4 md:px-8">
                ...
                <p className="text-[#070707] text-center font-poppins text-base sm:text-lg md:text-[20px] font-normal leading-[160%] tracking-[0.1px] max-w-3xl mx-auto mb-12">
                    دعونا نعمل معًا. سواء كنت تبحث عن التوسع في المملكة العربية السعودية أو  <br />
                    استكشاف آفاق استثمار جديدة، فإن أدماس هو شريكك الموثوق.
                </p>
                ...
                <div className="flex flex-col lg:flex-row gap-12 justify-between">
                    ...
                    <form className="w-full lg:w-1/2 space-y-4">
                        <input
                            type="text"
                            placeholder="اسمك"
                            className="w-full border text-right border-gray-300 rounded-sm px-4 py-2 focus:outline-none focus:ring-1 focus:ring-[#002B5B]"
                        />
                        <input
                            type="email"
                        ...
                        <input
                            type="text"
                            placeholder="مجال الخدمة المهتم به"
                            className="w-full border text-right border-gray-300 rounded-sm px-4 py-2 focus:outline-none focus:ring-1 focus:ring-[#002B5B]"
                        />
                        <textarea
                            placeholder="اكتب رسالتك"
                            className="w-full border text-right border-gray-300 rounded-sm px-4 py-2 h-28 focus:outline-none focus:ring-1 focus:ring-[#002B5B]"
                        ></textarea>
                        <button
                            type="submit"
